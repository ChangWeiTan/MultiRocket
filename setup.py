...
setup(
    ...
    description='''MultiRocket: Effective summary statistics for convolutional outputs in time series classification''',
    long_description=read('README.md'),
    long_description_content_type='text/markdown',
    packages=find_packages(include=['multirocket','catch22A']),
    py_modules = ['utils'],
    python_requires='>=3.7',
